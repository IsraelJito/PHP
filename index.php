    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h1 class="title-blue">Why we should protest peacefully</h1>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                            <div class="media-body">
                                <h5>Success Rate</h5>
                                Over time non-violent protest has higher success rate than violent protest.
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="400" data-aos-duration="600">
                            <div class="media-body">
                                <h5>Our Children</h5>
                                Please our children are victims of these violence and are terrified.
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800">
                            <div class="media-body">
                                ...
                                When we remain non-violent it reveals the brutality of the violent opponents.
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                            <div class="media-body">
                                ...
                                Prevents us from becoming what we are protesting against.
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
                    <div class="title">
                        <h6 class="title-primary">Our Police</h6>
                        <h1 class="title-blue">One Nigeria</h1>
                    </div>
                    <p>We love and support our police but this act of brutality is unacceptable.
                            ...
                            <div class="row">
                                <div class="offset-lg-1 col-lg-10">
                                    ...
                                    <h5 data-aos="fade-up" data-aos-delay="200" data-aos-duration="600"
                                        data-aos-offset="0">John</h5>
                                    <span data-aos="fade-up" data-aos-delay="400" data-aos-duration="600"
                                        data-aos-offset="0" style="color: black;">UI/UX
                                        Designer</span>
                                    <p data-aos="fade-up" data-aos-delay="600" data-aos-duration="600"
                                        data-aos-offset="0">Ash's tactics &
                                        books have helped me a lot in my understanding on how social
